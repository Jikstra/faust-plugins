...
lsf_toggle = checkbox("[3]lsf enable") : invertBool;
lsf_fc     = hslider(" [1]lsf fc[midi:ctrl 1]", 200, 30, 2000, 1) : si.smoo;
lsf_n      = 3;
//lsf_gain   = hslider(" [2]lsf gain", -75, -200, 6, 0.001) : si.smoo;
lsf_gain = ma.INFINITY * -1; 


sculpt_eq_toggle = checkbox("[20]sculpt enable") : invertBool;
...
sculpt_eq_n      = 5;
sculpt_eq_gain   = hslider(" [23]sculpt gain[midi:ctrl 3]", 0, -40, 6, 0.001) : si.smoo;

hsf_toggle = checkbox("[20]hsf enable") : invertBool;
